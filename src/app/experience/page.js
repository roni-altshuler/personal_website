  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.card}>
        <div className={styles.cardHeader}>
          <div className={styles.titleContainer}>
              <Image src={czBiohubLogo} alt="CZ Biohub SF Logo" className={styles.logoLarge} />
      ...
      <div className={styles.card}>
        <div className={styles.cardHeader}>
          <div className={styles.titleContainer}>
              <Image src={ucscGenomicsLogo} alt="UCSC Genomics Institute Logo" className={styles.logo} />
      ...
      <div className={styles.card}>
        <div className={styles.cardHeader}>
          <div className={styles.titleContainer}>
              <Image src={crisprLogo} alt="CRISPR Therapeutics Logo" className={styles.logo} />
